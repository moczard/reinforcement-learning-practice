...
def off_policy_mc_prediction(env, iterations, policy_probs, epsilon=0.01, gamma=1):
    ...
    for i in range(iterations):
        ...
        for t in reversed(range(len(episode))):
            ...
            w = w * (policy_probs(states[t], actions[t]) /
                     get_prob_epsilon_greedy(states[t], actions[t], epsilon, q_values, env.action_space.n))
